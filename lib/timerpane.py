...
class timerpane(object):
    ...
    def lap_up_clicked_cb(self, button, data=None):
        ...
        if self.status in ['running', 'arm50', 'armint', 'arm150', 'armfin']:
            self.missedlap()
    ...
    def prestart(self, inttod, recov=4):
        """Trigger an intermediate time."""
        self.splits.append(inttod)
        
    def prestartrw(self, inttod, recov=4):
        """Trigger an intermediate time."""
        self.splitsrw.append(inttod)
    ...
    def intermedrw(self, inttod, recov=4):
        """Trigger an intermediate time."""
        self.splitsrw.append(inttod)
        self.torunning() 
 
    def intermedsr(self, inttod, recov=4):
        """Trigger an intermediate time."""
        self.splitssr.append(inttod)
        self.torunning() 

    def intermedfrw(self, inttod, recov=4):
        """Trigger an intermediate time."""
        self.splitsrw.append(inttod)
    ...
    def toarm50(self):
        """Arm timer for 50m Split."""
        self.status = 'arm50'
        uiutil.buttonchg(self.b, uiutil.bg_armint, '50m Armed')
