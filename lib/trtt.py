...
class trtt(object):
            ...
            if cb is not None:
                ...
                if len(seen) > 0:
                    if self.start:
                        ...
                        et = seen[-1]
                    cr.set_property('text', u'[' + et.rawtime(2) + u']')
                    cr.set_property('style', pango.STYLE_OBLIQUE)
                else:
    ...
    def bounceteam(self, team, cat, time):
        ...
        tstr = time.rawtime(2) + u' ' # hunges blanked
    ...
    def bounceruntime(self, team, cat):
        ...
        if team in self.teamtimes:
            tstr = self.teamtimes[team].rawtime(2) + u' '
        else: 
